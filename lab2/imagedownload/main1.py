...
def download_images_and_create_annotation(keyword: str, save_dir: str, annotation_file: str, max_images: int=100)->None:
    """
     Загружает изображения по указанному ключевому слову и создает аннотацию для загруженных изображений.
     :param:keyword строка с ключевым словом для поиска изображений.
...
if __name__ == "__main__":
    ...
    parser.add_argument("keyword", type=str, help="Keyword for image search, e.g., 'cow'")
    ...
    parser.add_argument("--max_images", type=int, default=100, help="Maximum number of images to download (50-100)")

    args = parser.parse_args()

    download_images_and_create_annotation(
